...
public class LevelMedium extends AppCompatActivity implements View.OnClickListener
{
        ...
        public void onBackPressed() {
                super.onBackPressed();
                timer.cancel();
                startActivity(new Intent(LevelMedium.this,HomeActivity.class));
        }
        ...
        public void onClick(View view) {
                ...
                if(selectedButton1.getFontImageId() == memoryGameImageButton.getFontImageId())
                {
                        ...
                        {
                                Intent page = new Intent(LevelMedium.this,ScoreCard.class);
                                page.putExtra("time",timeCount);
                                page.putExtra("lose",lose);
                                page.putExtra("score",2500);
                ...
                timer =  new CountDownTimer(1000000, 1000) {
                        ...
                        public void onTick(long l) {
                                if(timeCount==60)
                                {
                                        ...
                                        startActivity(page);
                                        timer.cancel();
                                        Toast.makeText(LevelMedium.this,"Time Out",Toast.LENGTH_SHORT).show();
                                        finish();
