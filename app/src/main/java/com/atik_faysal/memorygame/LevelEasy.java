...
public class LevelEasy extends AppCompatActivity implements View.OnClickListener
{
        ...
        public void onBackPressed() {
                super.onBackPressed();
                timer.cancel();
                startActivity(new Intent(LevelEasy.this,HomeActivity.class));
        }
        ...
        public void onClick(View view) {
                ...
                if(selectedButton1.getFontImageId() == memoryGameImageButton.getFontImageId())
                {
                        ...
                        {
                                Intent page = new Intent(LevelEasy.this,ScoreCard.class);
                                page.putExtra("time",timeCount);
                                page.putExtra("lose",lose);
                                page.putExtra("score",1000);
               ...
               timer =  new CountDownTimer(1000000, 1000) {
                       ...
                       public void onTick(long l) {
                               if(timeCount==40)
                               {
                                       ...
                                       startActivity(page);
                                       timer.cancel();
                                       Toast.makeText(LevelEasy.this,"Time Out",Toast.LENGTH_SHORT).show();
                                       finish();
